...
namespace EternityRadioApp.Domain.Global
{
    public class AppModel : INotifyPropertyChanged
    {
        ...
        public NavigationStyle NavigationStyle
        {
            ...
            set
            {
                ...
                Shell.Current.FlyoutBehavior = FlyoutBehavior.Disabled; // IsTabBarVisible ? FlyoutBehavior.Disabled : FlyoutBehavior.Flyout;
            }
        }
